...
export default function NovedadesEdit({ post, categories = [] }) {
    ...
    async function handleSave() {
        ...
        try {
            ...
            await axios.put(`/admin/api/posts/${post.id}`, payload);
            emitAdminToast("Novedad guardada correctamente.", "success");
